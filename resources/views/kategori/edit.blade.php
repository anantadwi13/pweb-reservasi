    ...
    <div class="row">
        ...
        <div class="offset-lg-2 offset-2 col-lg-8 col-8">
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" method="POST" action="{{route('kategori.update', $kategori)}}">
                    {{csrf_field()}}
                    <input type="hidden" name="_method" value="PUT">
                    <div class="card-body">
                        <div class="form-group">
                            <label for="namaKategori">Kategori</label>
                            <input type="text" class="form-control" id="namaKategori" name="kategori" placeholder="Nama kategori" value="{{$kategori->nama}}">
                        </div>
                    </div>
                    <!-- /.card-body -->
